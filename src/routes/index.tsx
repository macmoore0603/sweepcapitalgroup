          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {[
              ...
              },
              {
                ...
                desc: "The Playbook plus personal coaching from me — I walk you through every setup, review your trades, and stay with you until you're consistently profitable.",
                features: ["Everything in The Playbook", "1:1 step-by-step walkthroughs", "Direct messaging access", "Coaching until profitable"],
              ...
              },
              {
                ...
                desc: "Hands-off — I trade your account for you. Guaranteed $2,000 minimum profit within a 3–4 week window or your money back.",
                features: ["Fully managed account", "Guaranteed $2k minimum", "3–4 week window", "Weekly performance updates"],
              ...
              },
              {
                ...
                desc: "Everything I offer in one package — full course, 1-on-1 mentorship, and managed trading with the $2k guarantee. The fastest path from beginner to profitable.",
                features: ["Full Playbook access", "1:1 mentorship until profitable", "Managed trading ($2k guarantee)", "Highest-priority access to Mac"],
