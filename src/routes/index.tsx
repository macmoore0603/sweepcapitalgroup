          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {[
              ...
              },
              {
                ...
                desc: "Everything I offer in one package — The Edge, 1-on-1 apprenticeship, and managed trading with the $2k guarantee. The fastest path from beginner to profitable.",
                features: ["Full Edge course access", "1:1 mentorship until profitable", "Managed trading ($2k guarantee)", "Highest-priority access to Mac"],
                cta: "Go Full Send",
                featured: false,
              },
            ].map((tier) => (
