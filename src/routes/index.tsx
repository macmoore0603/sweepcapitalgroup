          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border">
            {[
              ...
              },
              {
                ...
                desc: "Everything in the Blueprint plus step-by-step personal guidance until you're profitable.",
                features: ["Everything in The Blueprint", "1:1 step-by-step walkthroughs", "Direct messaging access", "Coaching until profitable"],
              ...
              },
              {
                ...
                desc: "I trade your account for you. Guaranteed $2,000 minimum profit in a 3–4 week window.",
