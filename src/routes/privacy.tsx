...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — Momentum Capital Group" },
      { name: "description", content: "Privacy Policy for Momentum Capital Group and Sierra messaging services." },
      { property: "og:title", content: "Privacy Policy — Momentum Capital Group" },
      { property: "og:description", content: "Privacy Policy for Momentum Capital Group and Sierra messaging services." },
