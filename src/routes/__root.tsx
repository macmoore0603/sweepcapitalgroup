...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Momentum Capital Group — Institutional Trading" },
      ...
      { name: "author", content: "Momentum Capital Group" },
      { property: "og:title", content: "Momentum Capital Group — Institutional Trading" },
      ...
      { name: "twitter:title", content: "Momentum Capital Group — Institutional Trading" },
      ...
      { property: "og:image:alt", content: "Momentum Capital Group — Success is the only edge." },
      { name: "twitter:image", content: "https://momentumcapitalgroup.com/og-card.jpg" },
      { name: "twitter:image:alt", content: "Momentum Capital Group — Success is the only edge." },
    ],
    links: [
      {
        rel: "stylesheet",
