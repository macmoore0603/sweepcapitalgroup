...
export const Route = createFileRoute("/leadership")({
  head: () => ({
    meta: [
      { title: "Leadership — Momentum Trading" },
      {
        name: "description",
        content:
          "Meet the leadership of Momentum Trading: founder Mac Moore and partner Christopher Nguyen, leading a private trading practice from Atlanta, Georgia.",
      },
      { property: "og:title", content: "Leadership — Momentum Trading" },
      {
...
const LEADERS: Leader[] = [
  {
    ...
    image: macMoore,
    bio: [
      "Three years on the desk taught Mac one lesson worth repeating: the market does not reward intelligence — it rewards discipline. He founded Momentum Trading in Atlanta to compress that lesson into a deliberate, repeatable framework for the traders he chooses to mentor.",
  ...
  },
  {
    ...
    location: "Atlanta, Georgia",
    bio: [
      "Christopher co-founded Momentum Trading alongside Mac Moore, leading strategy design, risk architecture, and mentee selection. His focus is the quantitative underwriting of every position — building the rails that keep the firm's discipline measurable rather than theoretical.",
      ...
      <header className="px-6 md:px-10 pt-20 md:pt-28 pb-16 md:pb-20 border-b border-border">
        <div className="max-w-5xl mx-auto flex flex-col gap-6">
          ...
          <p className="max-w-[60ch] text-base md:text-lg text-muted-foreground text-pretty">
            Momentum Trading is led by a deliberately small team out of Atlanta, Georgia. Every
              ...
              <div className="flex flex-col gap-4">
                <div className="aspect-[4/5] w-full bg-gradient-to-br from-accent/30 via-muted to-background border border-border overflow-hidden relative">
                  {leader.image ? (
                    <img
                      src={leader.image}
                      alt={`Portrait of ${leader.name}, ${leader.title} of Momentum Trading`}
                      width={800}
                      height={1000}
                      loading="lazy"
